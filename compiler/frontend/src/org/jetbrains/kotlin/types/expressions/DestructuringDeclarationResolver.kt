...
class DestructuringDeclarationResolver(
    ...
    fun resolveLocalVariablesFromMultiDeclaration(
            scope: LexicalScope,
        ...
        for ((componentIndex, entry) in destructuringDeclaration.entries.withIndex()) {
            ...
            ExpressionTypingUtils.checkVariableShadowing(scope, context.trace, variableDescriptor)
    ...
    fun defineLocalVariablesFromMultiDeclaration(
            ...
            initializer: KtExpression?,
            context: ExpressionTypingContext
    ) = resolveLocalVariablesFromMultiDeclaration(
            writableScope, destructuringDeclaration, receiver, initializer, context
    ).forEach(writableScope::addVariableDescriptor)
